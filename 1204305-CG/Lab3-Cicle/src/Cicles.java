...
public class Cicles extends Window {
    ...
    public void display(GLAutoDrawable drawable) {
        ...
        drawMidpointCircle(gl, 100, 100, 50, true); // Circle with points

        // Draw a circle using lines
        gl.glColor3f(0, 0, 1); // Blue color
        drawMidpointCircle(gl, 200, 100, 50, false); // Circle with lines

        // Draw an ellipse using points
        gl.glColor3f(0, 1, 0); // Green color
        drawMidpointEllipse(gl, 100, 200, 70, 40, true); // Ellipse with points

        // Draw an ellipse using lines
        gl.glColor3f(1, 0, 1); // Magenta color
        drawMidpointEllipse(gl, 200, 200, 70, 40, false); // Ellipse with lines
    }
